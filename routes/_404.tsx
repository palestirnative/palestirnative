...
export default function Error404({ state }) {
  return (
    ...
    <div class="container flex items-center min-h-screen px-6 py-12 mx-auto">
        <div>
            <p class="text-sm font-medium text-green-500 dark:text-green-400">{state.locale["404 error"]}</p>
            <h1 class="mt-3 text-2xl font-semibold text-gray-800 dark:text-white md:text-3xl">{["We can’t find that page"]}</h1>
            <p class="mt-4 text-gray-500 dark:text-gray-400">{state.locale["Sorry, the page you are looking for doesn't exist or has been moved"]}</p>
            ...
            <div class="flex items-center mt-6 gap-x-3">
                ...
                <a href="/" class="w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-green-500 rounded-lg shrink-0 sm:w-auto hover:bg-green-600 dark:hover:bg-green-500 dark:bg-green-600">
